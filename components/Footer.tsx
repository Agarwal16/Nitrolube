      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="flex flex-col items-center space-y-8 md:space-y-12">
          ...
          <div className="w-full flex justify-around items-start">
            {/* Quick Links */}
            <div className="flex flex-col items-center text-sm flex-1">
            ...
            <div className="flex flex-col items-center text-sm flex-1">
              ...
              <div className="flex flex-row items-center gap-3 flex-wrap justify-center">
                <a href="mailto:support@nitrolube.com" className="text-blue-100 hover:text-white transition-colors">
                  support@nitrolube.com
                </a>
                <a href="tel:+1800-NITRO-LUBE" className="text-blue-100 hover:text-white transition-colors">
                  +910000000000
                </a>
              </div>
            </div>
