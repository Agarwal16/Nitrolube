...
export default function GearOilPage() {
  const categoryProducts = products.gearOil || []

  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-blue-50 pt-32 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-8">Gear Oil</h1>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {categoryProducts.map((product) => (
              <div key={product.id} className="bg-white rounded-xl shadow-md p-3 flex flex-col">
                ...
                <h3 className="font-semibold text-lg mt-3 text-gray-900">Gear Oil</h3>
                {product.grade && (
