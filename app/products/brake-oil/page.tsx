...
export default function BrakeOilPage() {
  const categoryProducts = products.brakeOil || []

  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-blue-50 pt-32 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-8">Brake Oil</h1>
                ...
                return (
                  <div className="bg-white rounded-xl shadow-md p-3 flex flex-col">
                    <div className="relative w-full h-32 bg-gray-100 rounded-lg overflow-hidden mb-3">
                      <Image
                        src={brakeOilImages[index % brakeOilImages.length]}
                        alt={product.name || "Brake Oil"}
                        fill
